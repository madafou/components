<template>
  <el-table-column :key="item.prop" :type="item.type" :index="item.index" :columnKey="item.columnKey" :label="item.label"
    :prop="item.prop" :width="item.width" :minWidth="item.minWidth" :fixed="item.fixed"
